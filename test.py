...
data = {
    "nanme" : "Vibhoor Bhatnagar",
    "email" : "vibhoor@gmail.com",
...
list_of_records = [
    {
        ...
        'courceOffered' : 'Machine Learning with Deployment'
    },
    {
        'companyName': 'iNeuron',
        'product' : 'Affordable AI',
        'courceOffered' : 'Deep Learning  for NLP and Computer Vision'
    },
    {
        'companyName': 'iNeuron',
        'product' : 'Master Program',
        'courceOffered' : 'Data science Master Program'
    }
]
